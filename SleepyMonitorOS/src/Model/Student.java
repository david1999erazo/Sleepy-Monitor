			...
			try {
				...
				if(semaphoreMonitor.availablePermits()==0) {
					...
					if(semaphoreWaitingRoom.availablePermits()==0) {
						...
						/**
						 * This line sleeps the thread between 30 to 40 seconds.
						 * This represent the time the monitor helps the student
						 */
				...
				/**
				 * This condition check if the monitor is free and there is no student in the waiting room
				 */
